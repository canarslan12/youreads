jQuery(document).ready(function(){
	...
	hepsi = ["gece_modu","spoiler", "yildizli","kisi","sag_kapa","yazi_buyut","facebook","bugun_linki","ctrl","edit_tarih","newnumber","carpi","yuvarlak_hatlar"];
	isimler = ["gece modu hep açık kalsın","spoiler gözükmesin", "yıldızlı bkz.lar otomatik açılsın","sol frame'de yazar/yönetmen/şarkıcı daha küçük olsun","sağ taraftaki öneri panelini kapansın","yazılar biraz büyüsün","alttaki facebook şeyi yok olsun","sol frame'deki linkler bugün girilen yorumları açsın","ctrl+enter ile yorum gönderme","düzenlenen yorumlarda düzenleme tarihinin gözükmesi","kategorilerin üstündeki kırmızı balonlar yok olsun","başlık engelleme","deneysel yuvarlak hatlar (olumlu veya olumsuz yorumunuzu bildirin)"];
