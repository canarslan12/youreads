jQuery(document).ready(function(){
	...
	var hepsi = ["fa-area-chart", "fa-space-shuttle", "fa-bars", "fa-graduation-cap","fa-try", "fa-beer", "fa-comments","fa-heart","fa-newspaper-o","fa-male", "fa-book", "fa-building", "fa-headphones", "fa-gamepad", "fa-medkit", "fa-paint-brush", "fa-plane", "fa-film", "fa-gavel", "fa-question-circle", "fa-futbol-o", "fa-history", "fa-apple", "fa-eye", "fa-desktop", "fa-youtube-play", "fa-pencil-square-o", "fa-code", "fa-cutlery", "fa-copyright"];
	...
	ekle+='<div class="spacer"></div><input type="button" id="ayarla1" value="Ayarla" class="butonB"></form></div>';
	$('#a1').append(ekle);
